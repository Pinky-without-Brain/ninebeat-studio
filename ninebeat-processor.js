...
const SIMPLE_CALLS = {
    ...
    queuePatternIndex:          { fn: 'queuePatternIndex',          args: ['index'] },
...
const API_SPEC = {
    ...
    queuePatternIndex:            [null, ['number', 'number']],
    getActivePatternIndex:        ['number', ['number']],
    ...
    process (_inputs, outputs)
    {
        ...
        if (++this.playheadCounter >= PLAYHEAD_UPDATE_INTERVAL)
        {
            ...
            this.port.postMessage ({
                ...
                // Aktives Pattern des Pattern-Modus: daran erkennt die
                // Oberflaeche, dass eine Vormerkung am Umbruch gegriffen hat
                // (der Wechsel passiert in der Engine, nicht im Store).
                pattern: this.wasm.getActivePatternIndex (this.engine),
            });
        }
